...
export default async function handler(req, res) {
  ...
  try {
    ...
    console.log("Convert request params:", { from, to, amount });
    ...
    const apiUrl = `https://api.currencybeacon.com/v1/convert?api_key=${apiKey}&from=${from}&to=${to}&amount=${amount}`;
